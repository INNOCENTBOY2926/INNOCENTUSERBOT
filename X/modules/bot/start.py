...
async def start(app, message):
    ...
    reply_markup = InlineKeyboardMarkup([
        [
            InlineKeyboardButton("𝐒𝗎𝗉𝗉𝗈𝗋𝗍", url="https://t.me/THE_FUCKER_BOTS_2926"),
            InlineKeyboardButton("𝐂𝗁𝖺𝗇𝗇𝖾𝗅", url="https://t.me/THE_FUCKING_BOT_2926"),
            InlineKeyboardButton("𝐎𝗐𝗇𝖾𝗋", url="https://t.me/its_innocent_boy_8202"),
            InlineKeyboardButton("𝐑𝖾𝗉𝗈", url="https://github.com/nakuldkdhacker0026/INNOCENTUSERBOT"),
        ],
    ])
